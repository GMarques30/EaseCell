...
import com.easecell.ease_cell.domain.vo.Name;
...
public class NameTest {
  ...
  void should_not_be_able_to_create_a_invalid_names() {
    assertThrows(IllegalArgumentException.class, () -> new Name("", "Silva"));
    assertThrows(IllegalArgumentException.class, () -> new Name("Fernando", ""));
    assertThrows(IllegalArgumentException.class, () -> new Name("Fernando123", "Silva"));
    assertThrows(IllegalArgumentException.class, () -> new Name("Fernando", "Si1va"));
    assertThrows(IllegalArgumentException.class, () -> new Name("   ", "Silva"));
    assertThrows(IllegalArgumentException.class, () -> new Name("Fernando", "   "));
  }
  ...
  public void should_be_able_to_return_a_string_with_full_name() {
    Name name = new Name("John", "Doe");
    assertThat(name.getName()).isEqualTo("John Doe");
  }
}
